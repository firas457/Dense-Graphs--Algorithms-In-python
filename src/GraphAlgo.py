...
class GraphAlgo(GraphAlgoInterface):
    ...
    def shortest_path(self, id1: int, id2: int) -> (float, list):
        ...
        while node_next.get_Tag() != -1:
            ...
            bes_path.append(node_next.get_id())
        ...
        return self.G.get_node(bes_path[-1]).get_weight(), bes_path
    ...
    def plot_graph(self) -> None:
        ...
        for n in self.G.get_all_v().values():
            ...
            draw_node = plot.Circle(tuple, 0.00020, color='red')
            ax.add_artist(draw_node)

            pos0=n.get_position()[0] - 0.000135
            pos1=n.get_position()[1] + 0.00025

            plot.text(pos0, pos1, str(n.get_id()), fontsize=8, color='green')
            ...
            for destintion_node in n.edges_from_node():
                ...
                plot.arrow(source_pos[0], source_pos[1], dest_node_pos[0] - source_pos[0],
                           dest_node_pos[1] - source_pos[1], width=width, head_width=head_width,
